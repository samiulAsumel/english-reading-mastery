...
/**
 * Small hand-written outline-icon set (Feather-style: 24x24, stroke-based,
 * currentColor) — no icon-font/library dependency. Used by both
 * content.js (callout glyphs) and templates.js/pages.js (chrome), so it
 * lives dependency-free to avoid a require() cycle between those two.
 */
const ICONS = {
  ...
  gauge: '<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>',
...
function icon(name, className) {
  ...
  if (!inner) throw new Error(`icons.js: unknown icon "${name}"`);
