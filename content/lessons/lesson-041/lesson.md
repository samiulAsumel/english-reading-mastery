...
1. **The implementation of the new policy resulted in a reduction in customer complaints.** Identify the two nominalizations, convert each to a verb, and rewrite the sentence in plain English. <details class="answer"><summary>Show answer</summary><div class="answer-body">The two nominalizations are implementation and reduction, converting to implement and reduce. Plain English: The company implemented the new policy, and customer complaints decreased.</div></details>
2. **The evaluation of the proposal took place after the establishment of a review committee.** Rewrite this sentence using active verbs instead of nominalizations. <details class="answer"><summary>Show answer</summary><div class="answer-body">The nominalizations are evaluation and establishment, converting to evaluate and establish. Rewritten: The organization evaluated the proposal after it established a review committee.</div></details>

### Part B — Result In vs. Result From

3. **The improvement in delivery times resulted from the new routing software.** Identify which noun phrase is the cause and which is the effect. <details class="answer"><summary>Show answer</summary><div class="answer-body">The cause is the new routing software; the effect is the improvement in delivery times. Because the sentence uses "resulted from," the effect is named first and the cause follows, the reverse order of "resulted in."</div></details>
4. Write your own two sentences, one using "result in" and one using "result from," describing the same underlying cause-and-effect relationship in each direction. <details class="answer"><summary>Show answer</summary><div class="answer-body">Result in (cause first): The new training program resulted in higher employee retention. Result from (effect first): Higher employee retention resulted from the new training program. Both sentences describe the same underlying relationship, training causing retention, just stated in opposite directions.</div></details>

### Part C — Noun-of-X and Prepositional Patterns

5. **The impact of remote work on team communication has been widely discussed.** Rewrite this using "how...affects...". <details class="answer"><summary>Show answer</summary><div class="answer-body">How remote work affects team communication has been widely discussed.</div></details>
6. **With respect to cost, the new supplier was preferable; with respect to delivery speed, it was not.** Explain exactly what conclusion this sentence does, and does not, support about the supplier overall. <details class="answer"><summary>Show answer</summary><div class="answer-body">It supports the narrow conclusion that the new supplier was better on cost and worse on delivery speed, each judged separately. It does not support any overall conclusion about whether the new supplier was better or worse in general, since only two specific dimensions were compared and they point in opposite directions.</div></details>

### Part D — Preserving Modality, Scope, and Attribution

7. **Analysts have suggested that the merger may improve long-term profitability.** Identify the three things this sentence commits to (source, hedge, claim), and explain what would be lost if it were rewritten as "the merger improves long-term profitability." <details class="answer"><summary>Show answer</summary><div class="answer-body">Source: analysts, since the claim is attributed to them rather than stated as the author's own established fact. Hedge: "may," plus the hedged reporting verb "suggested," marking possibility rather than certainty. Claim: that the merger improves long-term profitability. Rewriting it as a flat statement would lose the attribution, since it would now read as the author's own established fact, and the hedge, since possibility would become certainty, both at once.</div></details>
8. **Not all of the recorded improvements can be attributed to the new software.** Rewrite this correctly, and then write the incorrect version that a careless reader might produce. <details class="answer"><summary>Show answer</summary><div class="answer-body">Correct: Some of the recorded improvements cannot be credited to the new software; other factors also played a part. Incorrect (careless): None of the recorded improvements can be attributed to the new software — this wrongly reads "not all" as "none," when the sentence only denies that every improvement traces back to the software, not that any of it does.</div></details>
...
9. Convert all four nominalizations in the first two sentences into verbs. <details class="answer"><summary>Show answer</summary><div class="answer-body">The four nominalizations are adoption, reduction, improvement, and introduction, converting to adopted, reduced, improved, and introduced: facilities adopted predictive maintenance systems, which has been associated with reduced unplanned downtime, though how much of that improvement is due to the systems alone is unclear, since many facilities also introduced revised training programs.</div></details>
10. Explain exactly what "has been associated with" preserves that "has caused" would lose. <details class="answer"><summary>Show answer</summary><div class="answer-body">"Has been associated with" preserves the fact that the two things occur together without claiming that one produced the other; "has caused" would assert a definite causal link the evidence does not establish, especially since the same facilities simultaneously introduced other changes that could equally explain the result.</div></details>
11. Explain what the two "with respect to" clauses each cover, and why combining them into one claim about "overall performance" would misrepresent the passage. <details class="answer"><summary>Show answer</summary><div class="answer-body">The first "with respect to" clause covers downtime specifically, where the evidence is described as reasonably consistent; the second covers overall production costs, where the picture is considerably less clear. Combining them into one claim about overall performance would falsely apply the strong downtime evidence to costs as well, when the passage explicitly says the cost evidence is weaker.</div></details>
12. Using the dense-sentence reading checklist from this lesson, work through the sentence: *The extent to which this improvement can be attributed solely to the new systems remains unclear, given that many of the same facilities simultaneously introduced revised staff training programs.* Identify the main clause, the hedge, the scope word, and the competing explanation, then write a faithful plain-English version. <details class="answer"><summary>Show answer</summary><div class="answer-body">Main clause: the extent...remains unclear. Hedge: remains unclear, plus the whole "extent to which" framing, which leaves the actual degree open. Scope word: solely, which limits the claim to whether the systems alone explain the improvement. Competing explanation: many of the same facilities simultaneously introduced revised staff training programs. Faithful version: It's not clear how much of the improvement in downtime is due to the new systems alone, since many facilities also introduced revised staff training at the same time.</div></details>
