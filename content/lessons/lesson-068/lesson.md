...
1. **All submissions are reviewed within 48 hours, except those flagged for compliance review.** Identify the main rule and the exception. <details class="answer"><summary>Show answer</summary><div class="answer-body">The main rule is that all submissions are reviewed within 48 hours. The exception is submissions flagged for compliance review, which are excluded from that 48-hour timeline.</div></details>
2. **Enter the verification code within 10 minutes. Otherwise, you will need to request a new one.** Identify the fallback path this sentence introduces. <details class="answer"><summary>Show answer</summary><div class="answer-body">The fallback path is requesting a new verification code, which becomes necessary if the code is not entered within the 10-minute window. "Otherwise" names the alternative route taken when the main condition, entering the code in time, is not met.</div></details>
3. **The elevator is out of service; failing that, use the stairs at the north entrance.** Explain why "failing that" is oddly used here, and what the sentence most likely intends instead. <details class="answer"><summary>Show answer</summary><div class="answer-body">"Failing that" normally names the next step to take when a prior attempted action does not work, but here nothing was actually attempted — the elevator is simply already out of service, not a failed attempt in progress. The sentence most likely intends a plain alternative, such as "instead" or "alternatively," rather than a genuine fallback from a failed action.</div></details>

### Part B — In Case, In the Event That, and Where-Phrases

4. **Keep a printed copy of your itinerary in case the mobile app is unavailable at check-in.** Explain why this is a precaution rather than a plain conditional. <details class="answer"><summary>Show answer</summary><div class="answer-body">This is a precaution because the printed copy is prepared against a possible future problem, the app being unavailable, independent of whether that problem ever actually occurs. A plain conditional would instead have the app's unavailability directly trigger some outcome, such as "if the app is unavailable, ask staff for a paper itinerary."</div></details>
5. **In the event that a data breach occurs, affected users must be notified within 72 hours.** Restate this sentence using plain "if," without changing its meaning. <details class="answer"><summary>Show answer</summary><div class="answer-body">If a data breach occurs, affected users must be notified within 72 hours.</div></details>
6. **Where possible, meetings should be scheduled to avoid overlapping time zones.** Explain what hidden condition "where possible" attaches to this instruction. <details class="answer"><summary>Show answer</summary><div class="answer-body">"Where possible" attaches a hidden feasibility condition: meetings should be scheduled to avoid overlapping time zones only when doing so is practically achievable, not as an absolute requirement that must be met in every single case.</div></details>

### Part C — Even If, Only When, and Not Unless

7. **The warranty remains valid even if the product is used outside its original country of purchase.** Explain why this is the logical opposite of an exception. <details class="answer"><summary>Show answer</summary><div class="answer-body">An exception would carve out a case where the warranty does not apply, but "even if" does the reverse: it insists the warranty stays valid through the stated condition, use outside the original country, rather than being excluded by it.</div></details>
8. **The system escalates a ticket only when it has remained unresolved for more than 24 hours.** Diagram this sentence's logical direction, the way this lesson diagrammed "only when the temperature rises." <details class="answer"><summary>Show answer</summary><div class="answer-body">Ticket escalated leads to it has remained unresolved for more than 24 hours (must have occurred). Being unresolved for over 24 hours becomes a necessary condition for escalation, so escalation happening tells you the 24-hour condition has already been satisfied — the same direction shift as "alert sent" implying "temperature has risen."</div></details>
9. **The application will not proceed to the next stage unless every mandatory field has been completed.** Untangle this double negative conditional into a positive necessary-condition statement. <details class="answer"><summary>Show answer</summary><div class="answer-body">The application will proceed to the next stage only if every mandatory field has been completed — completing all mandatory fields is a necessary condition for proceeding.</div></details>

### Part D — Exception, Limitation, and Alternative

10. **The platform supports most file formats, although very large files may take longer to process.** Explain why this is a limitation rather than an exception. <details class="answer"><summary>Show answer</summary><div class="answer-body">This is a limitation because no case is actually excluded from the platform's file-format support — every format is still supported. Processing very large files instead reveals a genuine constraint on how well that capability performs under size pressure, rather than carving any format out of the rule.</div></details>
11. **Payments can be made online. Alternatively, customers may pay by phone.** Explain why "alternatively" here does not describe an exception to the online-payment rule. <details class="answer"><summary>Show answer</summary><div class="answer-body">"Alternatively" offers a second, equally valid payment option alongside online payment rather than excluding any case from the online-payment rule. Both paths remain fully available side by side, with neither one overriding or replacing the other.</div></details>
12. **The team chose to extend the deadline instead of reducing the project's scope.** Identify the rejected option and the chosen option. <details class="answer"><summary>Show answer</summary><div class="answer-body">The rejected option is reducing the project's scope. The chosen option is extending the deadline.</div></details>

### Part E — Full Passage Analysis

Return to this lesson's guided reading passage about carry-on baggage.

13. State the passage's main rule and the condition attached to it. <details class="answer"><summary>Show answer</summary><div class="answer-body">The main rule is that passengers may board with one carry-on bag. The condition attached is that the bag must meet the airline's size and weight limits.</div></details>
14. Identify the exception to the oversized-bag rule, and its exact trigger. <details class="answer"><summary>Show answer</summary><div class="answer-body">The exception is that gate check-in for oversized bags may be refused. Its exact trigger is the flight already being at full capacity, at which point the bag must instead travel as standard checked luggage.</div></details>
15. Identify the sentence that functions as a recommendation rather than a strict rule, and explain how you know. <details class="answer"><summary>Show answer</summary><div class="answer-body">"Where possible, passengers should check bags at the counter rather than the gate" functions as a recommendation, not a strict rule, because "where possible" scopes the instruction to feasibility and "should" states advice rather than an obligation such as "must."</div></details>
16. Explain why the passage's final sentence is an "even if" override, and what earlier approval it overrides. <details class="answer"><summary>Show answer</summary><div class="answer-body">The final sentence uses "even when," functioning the same way as "even if," to state that crew authority to move a bag to the hold survives regardless of the stated condition. It overrides the earlier approval that a bag had already been approved for cabin storage, since that approval does not guarantee the bag stays in the cabin if overhead space runs out.</div></details>
