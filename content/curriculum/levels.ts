/**
 * The eight-level skill journey. Lesson numbers never determine level —
 * each lesson declares its own `level` slug in frontmatter. This file only
 * defines what a level means, not which lessons belong to it.
 */
